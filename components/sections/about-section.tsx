...
const timeline = [
  {
    ...
    description: 'Recognized for contributions to the developer community and innovative web solutions.',
  },
  {
    year: '2023',
    title: 'GitHub Star',
    description: 'Awarded for open source contributions and community engagement.',
  },
  {
    year: '2022',
    title: 'Founded Boilerplate',
    description: 'Launched a community to empower developers with modern web tools.',
  },
  {
    year: '2020',
          ...
          >
            <div className="glass-light shadow-glass rounded-[16px] p-8">
              ...
              <div className="flex items-start gap-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#1C1C1E] mb-1">Di Huynh</h3>
                  <p className="text-[#FF4D8E] font-medium mb-2">Full-Stack Developer</p>
                  <div className="flex items-center gap-3 text-sm text-[#1C1C1E]/50">
                    <a href="mailto:hello@di-huynh-dev.com" className="hover:text-[#1C1C1E] transition-colors">
                      hello@di-huynh-dev.com
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 text-[#1C1C1E]/70 leading-relaxed">
                ...
                <p>
                  As an open-source contributor, I explore the frontiers of web technology. My work spans from building web applications to sharing knowledge about the future of development.
                </p>
                <p>
