...
const socialLinks = [
  ...
  {
    name: 'Website',
    handle: 'github.com/di-huynh-dev',
    href: 'https://github.com/di-huynh-dev',
    icon: Globe,
    color: '#FF4D8E',
  },
    ...
    <section className="py-24 px-6 bg-gradient-to-b from-[#1C1C1E] to-[#0C0C0E] text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <motion.a
            href="https://github.com/di-huynh-dev/nextjs-bun-starter"
            target="_blank"
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <img
              src="https://github.com/di-huynh-dev.png"
              alt="Di Huynh"
              className="w-20 h-20 rounded-full border-2 border-[#FF4D8E]/50"
            />
            <div className="text-center md:text-left">
              <h4 className="text-xl font-bold mb-1">Di Huynh</h4>
              <p className="text-white/60 mb-2">Developer | Open Source Contributor</p>
