...
const socialLinks = [
  { href: "https://github.com/di-huynh-dev", icon: Github, label: "GitHub" },
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-3">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-white">Di Huynh</span>
            </Link>
            <p className="text-white/50 text-sm">Fly High With Di Huynh</p>
          </div>
          ...
          <div className="pt-4 border-t border-white/10 w-full text-center">
            <p className="text-sm text-white/40">
              &copy; {currentYear} Di Huynh. All rights reserved.
            </p>
          </div>
        </div>
      </div>
